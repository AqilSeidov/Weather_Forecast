 ...
 * @author Tuf
 */
public class weather_main extends javax.swing.JFrame {

    /**
     * Creates new form weather_main
     */
    public weather_main() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //String city_name = jTextField1.getText();
        String city_name = jTextField1.getText().trim();
    ...
    private void parseAndDisplayWeather(String jsonResponse) {
        ...
        if (temperature - temp >= 0.5 && temperature >= 0){
            temp++;
            jLabel5.setText(temp + " °C");
        }
        else if (temperature - temp < 0.5 && temperature >= 0){
            jLabel5.setText(temp + " °C");
        }
        else if(temperature + temp <= -0.5 && temperature <= 0){
            temp--;
    ...
    public static void main(String args[]) throws UnsupportedLookAndFeelException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(weather_main.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 java.awt.EventQueue.invokeLater(() -> new weather_main().setVisible(false));
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new weather_main().setVisible(true);
            }
        });
    }
